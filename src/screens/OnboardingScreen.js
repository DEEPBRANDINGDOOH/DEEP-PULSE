...
const SLIDES = [
  {
    ...
    subtitle: 'The Solana Mobile Notification Hub',
    description: 'Get real-time push notifications from your favorite Solana projects — DeFi, NFTs, Gaming, DAOs',
    icon: 'notifications',
    color: '#FF9F66',
  },
  {
    id: 2,
    title: 'Subscribe to Your Favorite Solana Hubs',
    subtitle: 'Free forever. No strings attached',
    description: 'Subscribe to brand and community hubs on Solana. Get exclusive alpha, early announcements, token drops, mint alerts, and insider updates — straight to your phone',
    icon: 'rocket',
    color: '#4CAF50',
  },
  {
    id: 3,
    title: 'DAO Boost & Talent',
    subtitle: 'Community-powered growth',
    description: 'Propose missions to brands and let the community fund them (DAO Boost). Showcase your skills to get hired by top projects (Talent). Your $SKR fuels every action',
    icon: 'people',
    color: '#9C27B0',
  },
  {
    id: 4,
    title: 'Engage & Climb the Ranks',
    subtitle: 'Every action counts',
    description: 'Send feedback, react to updates, subscribe to hubs, fund proposals — every action earns you DEEP Score points. Climb the Top 100 leaderboard and unlock higher tiers',
    icon: 'diamond',
    color: '#2196F3',
  },
];
