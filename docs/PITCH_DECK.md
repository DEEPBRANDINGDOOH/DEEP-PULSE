...
- Firebase Firestore sync — 13 parallel fetches on startup (hubs, pendingHubs, notifications, ads, talent, DAO proposals, feedbacks, ad creatives, custom deals, admin conversations, DOOH campaigns, user subscriptions, user score)
